...
class NewHouseForm extends Component {
    ...
    render() {
        return (
            <div className="new-house"><form onSubmit={ (event) => this.handleSubmit(event) } ><div className="row">
                ...
                <div className="col-12 col-sm-6"><fieldset className="center-align">
                    <input
                        type="radio"
                        name="dealType"
                        value="SELL"
                ...
                <div className="col-12 col-sm-6 vanish-sm" style={{ display: this.state.dealType === "SELL" || "none" }} >
                    &nbsp;
                </div>
                <div className="col-12 col-sm-6" >
                    <input
