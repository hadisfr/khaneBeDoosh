        ...
        return (
            <div className="toggle">
                <button className="btn btn-outline-violet toggle">
                    <span className="far fa-smile fa-lg" />&nbsp; ناحیهٔ کاربری
                </button>
                    ...
                    <div className="hover-menu">
                        ...
                        {this.props.user && (
                            <div className="unimportant">
                                <span className="center-right w50">
                                    اعتبار:
                                </span>
                                <span className="center-left w50">
                        ...
                        {this.props.user && (
                            <div>
                                <Link to={frontend_api.new_house}>
                                    <button className="btn btn-red">
                                        &nbsp;افزودن خانه&nbsp;
                                    </button>
                                </Link>
