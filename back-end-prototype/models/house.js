    ...
    var House = sequelize.define(
        ...
        },
        {
            getterMethods: {
                ...
                shortJson() {
                    var res = {};
                    res.id = encryptHouseId(
                        this.getDataValue('houseId'),
                        this.getDataValue('ownerId')
                    );
                ...
                async details() {
                    if (
                        ...
                        return;
                    let dHouse = new domainHouse();
                    if (dHouse.isRealEstate(this.ownerId)) {
                        let house = await (await dHouse.getRealEstate(this.ownerId)).getHouse(this.id);
